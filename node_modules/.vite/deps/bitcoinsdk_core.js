...
var BufferReader = class {
  ...
  readVarInt() {
    const { bigintValue, bytes } = decode4(this.buffer, this.offset);
    this.offset += bytes;
    return bigintValue;
  }
  readSlice(n) {
...
function psbtFromBuffer(buffer, txGetter) {
  let offset = 0;
  function varSlice() {
    const { numberValue: keyLen, bytes } = decode4(buffer, offset);
    offset += bytes;
...
function scriptWitnessToWitnessStack(buffer) {
  ...
  function readVarInt() {
    const vi = decode4(buffer, offset);
...
// node_modules/bitcoinsdk/esm/core/config.js
var VERSION_CONFIG = () => {
  const MAJOR = 0;
  const MINOR = 1;
  const PATCH = 1;
...
var OPENBOOK_PROTOCOL_CONFIG = () => ({
  ENDPOINT: "https://openbook.0.srcpad.pro"
});
var COUNTERPARTY_CONFIG = () => ({
...
// node_modules/bitcoinsdk/esm/core/bitcoin/api.js
...
// node_modules/bitcoinsdk/esm/core/utils/hex.js
function hex2bin(hexString) {
  var _a;
  const normalizedHex = hexString.replace(/\s/g, "");
  const bytes = new Uint8Array(((_a = normalizedHex.match(/.{1,2}/g)) == null ? void 0 : _a.map((byte) => Number.parseInt(byte, 16))) ?? []);
  return bytes;
}
...
// node_modules/bitcoinsdk/esm/core/counterparty/api.js
function balanceAdapter(data) {
  return data.map((item) => {
    ...
    return {
      ...
      description: ((_a = item.asset_info) == null ? void 0 : _a.description) ?? null,
      name: ((_b = item.asset_info) == null ? void 0 : _b.asset_longname) ?? item.asset,
      divisible: (_c = item.asset_info) == null ? void 0 : _c.divisible,
      locked: (_d = item.asset_info) == null ? void 0 : _d.locked,
      utxo: item.utxo ?? null,
...
async function composeAdapter(rawTransaction) {
  try {
    ...
    const tx = Transaction.fromHex(rawTransaction);
    const inputsToSign = [];
    let index = 0;
    for (const input of tx.ins) {
      const txid = bin2hex(input.hash.reverse());
      const { result: raw_tx } = await bitcoin2.getRawTransaction({ txid, verbose: false });
      const prevTx = Transaction.fromHex(raw_tx);
      const output = prevTx.outs[input.index];
      const address = address_exports.fromOutputScript(output.script, networks_exports.bitcoin);
      const isSegWit = output.script.length === 22 && output.script[0] === 0;
      psbt.addInput({
        hash: txid,
        index: Number(input.index),
        ...isSegWit ? { witnessUtxo: output } : { nonWitnessUtxo: hex2bin(raw_tx) }
      });
...
// node_modules/bitcoinsdk/esm/assets/index.js
var bitcoinImg = "https://openbook.0.srcpad.pro/static/assets/bitcoin.png";
var counterpartyImg = "https://openbook.0.srcpad.pro/static/assets/counterparty.png";

// node_modules/bitcoinsdk/esm/core/openbook/api.js
...
function btcPriceAdapter(data) {
  ...
  return btc == null ? void 0 : btc.current_price;
}
var openbook = {
  /**
  ...
  getAtomicSales: async ({ limit, page }) => {
    ...
    endpoint.searchParams.set("limit", (limit == null ? void 0 : limit.toString()) || "100");
    endpoint.searchParams.set("page", (page == null ? void 0 : page.toString()) || "1");
    const data = await fetch(endpoint);
  ...
  getAtomicSwapOrders: async ({ limit, page }) => {
    ...
    endpoint.searchParams.set("limit", (limit == null ? void 0 : limit.toString()) || "1000");
    endpoint.searchParams.set("page", (page == null ? void 0 : page.toString()) || "1");
    const data = await fetch(endpoint);
    const atomic_swaps = await data.json();
    return atomic_swaps;
...
// node_modules/bitcoinsdk/esm/core/stamps/api.js
var stamps = {
  /**
...
// node_modules/bitcoinsdk/esm/core/index.js
var bitcoinsdk = {
  counterparty,
  openbook,
  bitcoin: bitcoin2,
...
*/
//# sourceMappingURL=bitcoinsdk_core.js.map
