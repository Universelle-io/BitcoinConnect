...
export type RpcResponse<TResult extends object, TError extends RpcError = RpcError> = RpcSuccessResponse<TResult> | RpcErrorResponse<TError>;
...
export type DefineRpcMethod<TRequest extends RpcRequest<string, unknown>, TResponse extends RpcResponse<object>> = Record<TRequest['method'], {
    request: TRequest;
    response: TResponse;
}>;
