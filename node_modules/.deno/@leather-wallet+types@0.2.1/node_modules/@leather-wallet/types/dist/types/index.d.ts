...
export * from './utils';
export type MethodMap = DefineGetInfoMethod & DefineGetAddressesMethod & DefineSignPsbtMethod & DefineSignMessageMethod & DefineSendTransferMethod & DefineStxSignMessageMethod;
...
export interface RequestFn {
    <T extends MethodNames>(arg: T, params?: object | string[]): Promise<ExtractSuccessResponse<MethodMap[T]['response']>>;
}
